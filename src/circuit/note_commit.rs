    ...
    fn assign(
        ...
        layouter.assign_region(
            ...
            |mut region| {
                ...
                let b_1 = region.assign_advice(|| "b_1", self.col_r, 0, || b_1.inner().clone())?;
    ...
    fn assign(
        ...
        layouter.assign_region(
            ...
            |mut region| {
                ...
                let d_0 = region.assign_advice(|| "d_0", self.col_m, 0, || d_0.inner().clone())?;
                d_1.inner()
    ...
    fn assign(
        ...
        layouter.assign_region(
            ...
            |mut region| {
                ...
                let g_0 = region.assign_advice(|| "g_0", self.col_m, 0, || g_0.inner().clone())?;
    ...
    fn assign(
        ...
        layouter.assign_region(
            ...
            |mut region| {
                ...
                let h_1 = region.assign_advice(|| "h_1", self.col_r, 0, || h_1.inner().clone())?;
